...
class _BasePlot(object):
    ...
    def _scatter_plot(self, x, y, z, c, marker='.', markersize=3, zorder=0, **kwargs):
        """
    ...
    def _2d_scatter_plot(self, x, y, c, marker='.', markersize=3, zorder=0, **kwargs):
...
class _LunePlot(_FocalSpherePlot, _HistPlot):
    ...
    def _ax_plot(self, *args, **kwargs):
        ...
        if len(self.MTs.probability):
            ...
            return self._scatter_plot(x, y, z, color,  *args, **kwargs)
...
class _RiedeselJordanPlot(_FocalSpherePlot):
    ...
    def _boundary_lines(self, r):
        ...
        self._scatter_plot(x, y, z, c='k', marker='.', markersize=3, zorder=-1)
        # Get fill area
        if self.dimension < 3:
